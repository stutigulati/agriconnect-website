...
export default function PestDetectionPage({ onLoginOpen, onSignupOpen }) {
  ...
  const [cropCat,   setCropCat]   = useState('Cereals (Wheat, Rice, Maize)');  const [showModal, setShowModal] = useState(false);
...
<div className="flex items-center justify-center bg-[#f3f7f2] px-8 py-14">
  ...
  >
    ...
    <div className="mb-7">
      ...
      >
        <option value="Cereals (Wheat, Rice, Maize)">Cereals (Wheat, Rice, Maize)</option>
